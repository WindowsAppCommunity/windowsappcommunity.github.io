import { Text, Stack, PrimaryButton, Checkbox, TextField } from "office-ui-fabric-react";
                ...
                <HoverBox style={{ padding: "20px" }}>
                    <Stack horizontalAlign="start" tokens={{ childrenGap: 10 }} style={{ maxWidth: "100%", width: "300px" }}>
                        <TextField label="Developer name:"
                            ...
                            required
                            onChange={(e, value) => setProjectRequest({ ...projectRequest, name: value })} />

                        <TextField label="App name:"
                            styles={{ root: { width: "100%" } }}
                            required onChange={(e, value) => setProjectRequest({ ...projectRequest, appName: value })} />
                        ...
                        <TextField label="Description"
                            ...
                            onChange={(e, value) => setProjectRequest({ ...projectRequest, description: value })} />

                        <TextField label="Contact email:"
                            description="Optional"
                            styles={{ root: { width: "100%" } }}
                            onChange={(e, value) => setProjectRequest({ ...projectRequest, email: value })} />

                        <Checkbox
                            label="This project is private/secret"
                            onChange={(e, value) => setProjectRequest({ ...projectRequest, isPrivate: value })} />
