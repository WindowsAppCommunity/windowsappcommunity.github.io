...
import { Links, Images, FaIcon65Style } from "../common/const";
            ...
            <LinkCard>
              <Stack>
                ...
                <Stack horizontal verticalAlign="center" horizontalAlign="center" tokens={{ childrenGap: 7 }}>
                  ...
                  <FontAwesomeIcon style={FaIcon65Style} icon={["fab", "discord"]} />
                </Stack>
            ...
            <LinkCard>
              <Stack>
                ...
                <Stack horizontal verticalAlign="center" horizontalAlign="center" tokens={{ childrenGap: 7 }}>
                  ...
                  <FontAwesomeIcon style={FaIcon65Style} icon={["fab", "github"]} />
                </Stack>
              </Stack>
            </LinkCard>
          </HoverBox>
            ...
            <LinkCard>
              <Stack>
                ...
                <Stack horizontal verticalAlign="center" horizontalAlign="center" tokens={{ childrenGap: 7 }}>
                  ...
                  <FontAwesomeIcon style={FaIcon65Style} icon={["fab", "medium"]} />
                </Stack>
              </Stack>
            </LinkCard>
          </HoverBox>
